...
import dvidal.com.productschallenge.core.platform.Event
import dvidal.com.productschallenge.core.platform.EventObserver
...
fun <L : LiveData<Event<Throwable>>> LifecycleOwner.failure(liveData: L, body: (Throwable?) -> Unit) =
        liveData.observe(this, EventObserver(body))